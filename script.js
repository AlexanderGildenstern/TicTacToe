...
function fillShape(id) {
    if (!fields[id] && !gameOver) {  //wenn etwas in fields steht ist es erfüllt (true) wenn noch nicht in fields drin steht ist es false. zusätzlich ist es noch negiert.
...
function checkForWin() {
    ...
    if (fields[2] == fields[4] && fields[4] == fields[6] && fields[2]) {
        winner = fields[2];
        document.getElementById('line-8').style.transform = ' rotate(45deg) scaleY(1)';
    }
...
function restart() {
    ...
    for (let i = 4; i < 7; i++) {
        document.getElementById('line-' + i).style.transform = 'scaleY(0.0)';
    }
    document.getElementById('line-7').style.transform = 'rotate(-45deg) scaleY(0.0)';
    document.getElementById('line-8').style.transform = 'rotate(45deg) scaleY(0.0)';
